...
const App = () => {
  ...
  return (
    <div className="flex  max-h-screenzs px-6 items-center bg-[url('https://images.unsplash.com/photo-1584099799061-455b6b0b7f00?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
        ...
        <div className='flex flex-wrap h-[90vh] mt-6 gap-4 '>{
          details.map(function (elem, idx) {
            return (
              ...
              <div key={idx} className="w-50 h-70 bg-cover rounded-2xl flex flex-col flex-wrap justify-between items-center bg-[url('https://static.vecteezy.com/system/resources/thumbnails/010/793/873/small/a-lined-note-paper-covered-with-transparent-tape-on-a-yellow-background-with-a-white-checkered-pattern-free-png.png')]">
                <div className=' w-full  py-5'>
                  <h5 id='titleHeader' className='w-50 pl-5 pt-2 font-bold text-blue-400 text-xl wrap-break-word h-[10vh] overflow-scroll'>{elem.title}</h5>
                  <p id='paraHeader' className='pl-5 text-blue-400 wrap-break-word w-[27vh] h-[18vh] overflow-scroll'><b>{elem.description}</b></p>
                </div>
                <button onClick={()=>{
                  deleteAction(idx);
